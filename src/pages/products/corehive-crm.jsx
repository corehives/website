...
import {
  SiPostgresql, SiRedis, SiElasticsearch, SiKubernetes,
} from "react-icons/si";
...
const data = {
  ...
  processHeading:
    "A proven onboarding flow that gets your team productive in days, not months.",
  process: [
  ...
  stats: [
    { number: "35%", label: "Avg Deal Close Increase", description: "Teams using CoreHive CRM close more deals within the first quarter of adoption." },
    { number: "60%", label: "Admin Time Saved", description: "Automated logging and workflows eliminate manual data entry for your entire sales team." },
    { number: "4.8★", label: "Client Satisfaction", description: "Rated by revenue teams across SaaS, e-commerce, and professional services." },
    { number: "99.9%", label: "Uptime SLA", description: "Enterprise-grade infrastructure ensures CoreHive CRM is available whenever your team needs it." },
  ],
  faq: [
    { question: "How long does it take to migrate from our existing CRM?", answer: "Most migrations complete within 2–5 business days. We provide CSV import tools, API connectors for Salesforce and HubSpot, and a dedicated onboarding specialist to map your existing data to CoreHive CRM's schema." },
    { question: "Does CoreHive CRM integrate with our email and calendar?", answer: "Yes. CoreHive CRM offers two-way sync with Gmail, Google Calendar, Outlook, and Microsoft Teams. All emails and meeting notes are automatically logged to the relevant contact and deal records." },
    { question: "Can we customise fields, stages, and pipelines?", answer: "Fully. You can create unlimited custom fields, build multiple pipelines for different products or regions, and define your own deal stages with custom entry/exit criteria for each." },
    { question: "Is there a mobile app?", answer: "Yes. CoreHive CRM has native iOS and Android apps with offline mode, push notifications for deal activity, and the ability to log calls and update deals directly from the field." },
    { question: "How is data security handled?", answer: "CoreHive CRM is SOC 2 Type II certified. All data is encrypted at rest (AES-256) and in transit (TLS 1.3). We offer SSO via SAML 2.0, role-based access controls, and a full audit log trail." },
  ],
  cta: {
...
export default function CoreHiveCrm() {
