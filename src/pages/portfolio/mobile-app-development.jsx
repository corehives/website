...
import showcaseImg from "../../assets/mobile-app.png";
...
const data = {
  banner: {
    ...
    subtitle:
      "Explore our track record of delivering high-performance iOS and Android applications that users love and businesses rely on.",
  },
  showcaseImg,
  showcaseImage: showcaseImg,
  categories: [
    { title: "iOS Development", items: ["Swift & SwiftUI", "App Store Optimisation", "Apple Watch & iPad Extensions"] },
    { title: "Android Development", items: ["Kotlin & Jetpack Compose", "Google Play Compliance", "Wear OS Integration"] },
    { title: "Cross-Platform", items: ["React Native", "Flutter", "Shared Business Logic"] },
    { title: "Backend & APIs", items: ["REST & GraphQL APIs", "Real-Time Data (WebSocket)", "Push Notification Services"] },
    { title: "Testing & Launch", items: ["Automated UI Testing", "TestFlight Beta Programs", "App Store Submission"] },
  ],
  stats: [
    { num: "50+", label: "Apps Delivered", sub: "Across iOS, Android, and cross-platform targets." },
    { num: "2M+", label: "Total Downloads", sub: "Combined installs across all launched applications." },
  ...
  process: [
    ...
    { number: "02", title: "UI/UX Design", description: "Wireframes, interactive prototypes, and a full design system delivered for stakeholder approval before a single line of code is written." },
    { number: "03", title: "Agile Development", description: "Two-week sprint cycles with working builds delivered at the end of every sprint. Daily standups keep your team in the loop throughout." },
    { number: "04", title: "QA & Performance", description: "Automated UI tests, device fragmentation testing, load testing, and accessibility audits ensure your app performs across all target devices." },
    { number: "05", title: "App Store Launch", description: "End-to-end App Store and Google Play submission, including metadata optimisation, screenshot production, and review board response support." },
    { number: "06", title: "Post-Launch Support", description: "Crash monitoring, feature iteration based on user analytics, and OS update compatibility maintenance keep your app healthy after launch." },
  ],
