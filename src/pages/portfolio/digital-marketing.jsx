...
const data = {
  ...
  categories: [
    { title: "SEO & Content", items: ["Technical SEO Audits", "Content Strategy", "Link Building"] },
    { title: "Paid Advertising", items: ["Google Ads (PPC)", "Meta & LinkedIn Ads", "Programmatic Display"] },
    { title: "Social Media", items: ["Organic Growth Strategy", "Community Management", "Influencer Partnerships"] },
    { title: "Email Marketing", items: ["Lifecycle Campaigns", "A/B Testing", "Marketing Automation"] },
    { title: "Analytics & CRO", items: ["GA4 & GTM Setup", "Conversion Rate Optimisation", "Attribution Modelling"] },
  ],
  stats: [
    { num: "300%", label: "Avg Campaign ROI", sub: "Return on ad spend across our managed PPC accounts." },
    { num: "500K+", label: "Leads Generated", sub: "Qualified leads delivered to clients in the past 24 months." },
  ...
  process: [
    ...
    { number: "02", title: "Campaign Architecture", description: "Keyword research, audience segmentation, content calendar, and ad creative brief produced before any budget is committed to media." },
    { number: "03", title: "Launch & Optimise", description: "Campaigns are launched in controlled phases. Weekly optimisation cycles on bids, audiences, and creative prevent budget waste and accelerate learning." },
    { number: "04", title: "Content Production", description: "SEO articles, ad copy, email sequences, and social assets produced by specialist writers and designers with your brand voice guidelines." },
    { number: "05", title: "Measurement & Attribution", description: "GA4, GTM, and channel-level attribution configured so every lead and sale is traced to the campaign, ad group, and keyword that generated it." },
    { number: "06", title: "Report & Scale", description: "Monthly performance reviews with a clear view of ROAS, CPA, and pipeline contribution. Budget scaling decisions are made on data, not gut feel." },
  ],
...
export default function PortfolioDigitalMarketing() {
