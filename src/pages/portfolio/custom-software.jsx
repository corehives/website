...
const data = {
  ...
  categories: [
    { title: "Enterprise Systems", items: ["ERP & Workflow Platforms", "Inventory Management", "HR & Payroll Systems"] },
    { title: "Integration Projects", items: ["Legacy System Modernisation", "API Gateway Design", "Third-Party Connectors"] },
    { title: "Data Engineering", items: ["ETL Pipelines", "Data Warehousing", "BI Tool Integration"] },
    { title: "Industry-Specific", items: ["Healthcare (HIPAA)", "Legal Tech", "PropTech Platforms"] },
    { title: "Cloud & Infrastructure", items: ["Cloud Migration (AWS/GCP)", "Microservices Refactoring", "DevOps Automation"] },
  ],
  stats: [
    { num: "30+", label: "Enterprise Solutions", sub: "Custom-built platforms in production across 10+ industries." },
    { num: "100K+", label: "Daily Active Users", sub: "Combined across all custom software platforms we maintain." },
  ...
  process: [
    ...
    { number: "02", title: "Architecture Design", description: "System architecture, data models, API contracts, and infrastructure design reviewed and signed off before development begins." },
    { number: "03", title: "Iterative Delivery", description: "Modular build in two-week sprints. Core business processes are delivered first so teams can begin adoption and validation early." },
    { number: "04", title: "Integration & Migration", description: "Legacy data migration, third-party API integration, and end-to-end integration testing across every connected system." },
    { number: "05", title: "User Acceptance Testing", description: "Structured UAT with your operational teams across real-world scenarios before any production rollout begins." },
    { number: "06", title: "Training & Handover", description: "Admin documentation, user training sessions, and a minimum 90-day hypercare period with a dedicated support engineer." },
  ],
...
export default function PortfolioCustomSoftware() {
