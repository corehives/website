  ...
  return (
    <>
      ...
      <div className="w-full py-20 bg-gradient-to-b from-black/40 to-black/20 backdrop-blur-sm">
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-20 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                and software tailored to your specific needs. From development
                and implementation to ongoing maintenance and support, we're
                your one-stop shop for building the perfect tech solution.
              </p>
        ...
        <section className="relative  px-6 py-40 sm:px-12 md:px-20 lg:px-32 bg-gradient-to-r from-teal-900/40 via-teal-800/30 to-transparent">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-16 text-center">
              ...
              <p className="text-gray-400 max-w-3xl mx-auto text-sm md:text-base">
                Our team of experts consists of highly skilled software
                engineers, designers, developers, project managers, and quality
                assurance specialists. here's what we excel at.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="group relative overflow-hidden rounded-2xl border border-[#07BEB8]/40 hover:border-[#07BEB8] bg-gradient-to-br from-teal-900/50 via-black/60 to-black/80 p-7 transition-all flex-1">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    High-Performance, Secure Web Applications Built to Scale
                    with your Business and users.
                  </p>
                </div>
                ...
                <div className="group relative overflow-hidden rounded-2xl border border-[#07BEB8]/40 hover:border-[#07BEB8] bg-gradient-to-br from-teal-900/50 via-black/60 to-black/80 p-7 transition-all flex-1">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Feature-Rich, Intuitive & High-Performing Mobile Apps For
                    iOS & Andorid.
                  </p>
                </div>
              </div>
