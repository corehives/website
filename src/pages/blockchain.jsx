...
const whyItems = [
  { id: "security", title: "Security-First By Design", description: "Every contract ships with 100% test coverage, fuzz testing, Slither/MythX static analysis, and a full internal audit. Security isn't a post-deployment checklist — it's baked into every line of implementation." },
  { id: "gas", title: "Gas-Optimised as Standard", description: "Storage layout, opcode efficiency, and batching strategies are considered from the first design pass — not applied as a patch after deployment makes them expensive to change." },
  { id: "fullstack", title: "Full-Stack Web3, One Team", description: "From Solidity to React — protocol layer, subgraph indexing, and front-end wallet UX built by the same team that wrote the contracts. No handoffs, no seams, no finger-pointing." },
      ...
      <section id="home" className="relative z-0 flex w-full items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex w-full flex-col items-center justify-center px-6 py-20 text-center sm:px-12 md:px-20 lg:px-32">
          <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-5 py-2 backdrop-blur-sm">
            ...
            <span className="text-xs font-medium tracking-widest text-white uppercase">Web3 & Blockchain Engineering</span>
            <span className="h-1.5 w-1.5 rounded-full bg-[#07BEB8]" />
          </div>
          <h1 className="max-w-4xl text-center text-3xl font-extrabold leading-[1] tracking-wider text-white sm:text-4xl md:text-5xl lg:text-[3.5rem] xl:text-4xl">
            Build On Chain,{" "}
            <span className="text-[#07BEB8]">Ship With</span>
            <br />
            Confidence
          </h1>
          <p className="mt-6 max-w-xl text-center text-sm leading-relaxed text-white sm:text-base">
            Production-grade blockchain engineering — from smart contract architecture to full-stack dApp deployment, security-first and battle-tested.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-20 items-center">
          <div className="relative">
            <div className="relative group overflow-hidden rounded-lg border border-[#07BEB8]/30">
              <img src={IosApp} alt="blockchain development" className="w-full h-72 md:h-96 object-cover group-hover:scale-105 transition-transform duration-500" />
            ...
            <div className="flex items-center gap-4 pt-4">
              ...
              <div className="flex items-center gap-8">
                ...
                <div className="flex flex-col">
                  <span className="text-4xl font-bold text-[#07BEB8]">240+</span>
                  <span className="text-gray-400 text-sm">Contracts Deployed</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
            <div className="flex flex-col gap-6">
              <div className="group relative overflow-hidden rounded-2xl border border-[#07BEB8]/40 hover:border-[#07BEB8] bg-gradient-to-br from-teal-900/50 via-black/60 to-black/80 p-7 transition-all flex-1">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-white mb-3 leading-tight">$180M+ TVL<br />Managed</h3>
                <p className="text-gray-300 text-sm leading-relaxed">Total Value Locked Across DeFi Protocols Engineered by CoreHives — Zero Critical Security Incidents.</p>
              </div>
              <div className="group relative overflow-hidden rounded-2xl border border-[#07BEB8]/40 hover:border-[#07BEB8] bg-gradient-to-br from-teal-900/50 via-black/60 to-black/80 p-7 transition-all flex-1">
                <div className="w-12 h-12 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center mb-6"><img src={Analytic} className="h-5" alt="" /></div>
                <h3 className="text-xl md:text-2xl font-bold text-white mb-3 leading-tight">100% Audit<br />Pass Rate</h3>
                <p className="text-gray-300 text-sm leading-relaxed">Every Contract Deployed Has Passed Internal Security Audit With Zero Critical Findings — No Exceptions.</p>
              </div>
            </div>
            <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-6">
              <div className="group relative overflow-hidden rounded-2xl border border-[#07BEB8]/40 hover:border-[#07BEB8] bg-gradient-to-br from-teal-900/50 via-black/60 to-black/80 p-7 transition-all flex-1">
                <div className="w-12 h-12 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center mb-6"><img src={Analytic} className="h-5" alt="" /></div>
                <h3 className="text-xl md:text-2xl font-bold text-white mb-3 leading-tight">14+ Chains<br />Supported</h3>
                <p className="text-gray-300 text-sm leading-relaxed">EVM Chains, Solana, Cosmos & More — Full Cross-Chain Engineering Capability Without Extra Specialists.</p>
              </div>
              <div className="group relative overflow-hidden rounded-2xl border border-[#07BEB8]/40 hover:border-[#07BEB8] bg-gradient-to-br from-teal-900/50 via-black/60 to-black/80 p-7 transition-all flex-1">
                <div className="w-12 h-12 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center mb-6"><img src={Analytic} className="h-5" alt="" /></div>
                <h3 className="text-xl md:text-2xl font-bold text-white mb-3 leading-tight">Full-Stack Web3<br />Engineering</h3>
                <p className="text-gray-300 text-sm leading-relaxed">Protocol to Frontend — Smart Contracts, Subgraphs, Wallet UX & dApp Built by One Team With No Handoffs.</p>
              </div>
            </div>
          </div>
        </div>
