...
const whyItems = [
  { id: "speed", title: "72-Hour Placement Guarantee", description: "From brief to shortlisted engineer profiles in 48 hours. From accepted offer to first commit in 72 hours. We don't pad timelines to manage expectations — we deliver within them." },
  { id: "senior", title: "Senior-Only Talent Pool", description: "Every engineer on our roster has 5+ years of production experience and has passed a 4-stage vetting process. No juniors, no trainees, no bait-and-switch profile swaps." },
  { id: "timezone", title: "Timezone-Matched by Default", description: "Engineers are matched to your primary working hours — standups, Slack, and code reviews happen in real time, not the next morning." },
  { id: "trial", title: "2-Week Trial Sprint, No Commitment", description: "Every engagement starts with a paid 2-week trial sprint — a real deliverable from your backlog. You verify quality before any long-term commitment is made." },
  { id: "ip", title: "IP Ownership & NDAs Built In", description: "Full IP assignment, strict NDAs, and data-handling compliance are included in every engagement by default — not sold as premium add-ons." },
];
      ...
      <section id="home" className="relative z-0 flex w-full items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex w-full flex-col items-center justify-center px-6 py-20 text-center sm:px-12 md:px-20 lg:px-32">
          <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-5 py-2 backdrop-blur-sm">
            ...
            <span className="text-xs font-medium tracking-widest text-white uppercase">Senior Engineering Talent</span>
            <span className="h-1.5 w-1.5 rounded-full bg-[#07BEB8]" />
          </div>
          ...
          <p className="mt-6 max-w-xl text-center text-sm leading-relaxed text-white sm:text-base">
            Embed senior engineers directly into your team — zero recruitment overhead, no onboarding delays, first commit in 72 hours.
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-20 items-center">
          <div className="relative">
            <div className="relative group overflow-hidden rounded-lg">
              <img src={StaffOutSource} alt="tech staff outsourcing" className="w-full h-72 md:h-96 object-cover group-hover:scale-105 transition-transform duration-500" />
            ...
            <div className="flex items-center gap-4 pt-4">
              ...
              <div className="flex items-center gap-8">
                ...
                <div className="flex flex-col">
                  <span className="text-4xl font-bold text-[#07BEB8]">50+</span>
                  <span className="text-gray-400 text-sm">Senior Engineers</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
            <div className="flex flex-col gap-6">
              <div className="group relative overflow-hidden rounded-2xl border border-[#07BEB8]/40 hover:border-[#07BEB8] bg-gradient-to-br from-teal-900/50 via-black/60 to-black/80 p-7 transition-all flex-1">
                ...
                <h3 className="text-xl md:text-2xl font-bold text-white mb-3 leading-tight">72-Hour<br />First Commit</h3>
                <p className="text-gray-300 text-sm leading-relaxed">From Brief to First Engineer Embedded in Your Team in 72 Hours — No Recruitment, No Delays.</p>
              </div>
              <div className="group relative overflow-hidden rounded-2xl border border-[#07BEB8]/40 hover:border-[#07BEB8] bg-gradient-to-br from-teal-900/50 via-black/60 to-black/80 p-7 transition-all flex-1">
                <div className="w-12 h-12 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center mb-6"><img src={Analytic} className="h-5" alt="" /></div>
                <h3 className="text-xl md:text-2xl font-bold text-white mb-3 leading-tight">94% 12-Month<br />Retention Rate</h3>
                <p className="text-gray-300 text-sm leading-relaxed">Engineers Who Stay, Deliver, and Build Deep Product Knowledge — Not Contractors Who Disappear.</p>
              </div>
            </div>
            <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-6">
              <div className="group relative overflow-hidden rounded-2xl border border-[#07BEB8]/40 hover:border-[#07BEB8] bg-gradient-to-br from-teal-900/50 via-black/60 to-black/80 p-7 transition-all flex-1">
                <div className="w-12 h-12 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center mb-6"><img src={Analytic} className="h-5" alt="" /></div>
                <h3 className="text-xl md:text-2xl font-bold text-white mb-3 leading-tight">5-Stage Vetting<br />Process</h3>
                <p className="text-gray-300 text-sm leading-relaxed">Only the Top 5% of Applicants Make the Roster — Technical Assessment, Live Architecture Review & Trial Sprint.</p>
              </div>
              <div className="group relative overflow-hidden rounded-2xl border border-[#07BEB8]/40 hover:border-[#07BEB8] bg-gradient-to-br from-teal-900/50 via-black/60 to-black/80 p-7 transition-all flex-1">
                <div className="w-12 h-12 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center mb-6"><img src={Analytic} className="h-5" alt="" /></div>
                <h3 className="text-xl md:text-2xl font-bold text-white mb-3 leading-tight">8 Engineering<br />Disciplines</h3>
                <p className="text-gray-300 text-sm leading-relaxed">Full-Stack, Mobile, DevOps, AI/ML, Blockchain, QA & More — One Roster, Every Skill Your Roadmap Demands.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative px-6 py-20 sm:px-12 md:px-20 lg:px-32">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 mb-12">
            {["Web & Backend", "Mobile & DevOps", "Blockchain & AI"].map((tab) => {
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 sm:gap-5">
            {[
              ...
              { label: "Next.js", icon: <SiNextdotjs className="w-10 h-10 sm:w-12 sm:h-12 text-white" /> },
              ...
              { label: "Kubernetes", icon: <SiKubernetes className="w-10 h-10 sm:w-12 sm:h-12" style={{ color: "#326CE5" }} /> },
              { label: "Docker", icon: <SiDocker className="w-10 h-10 sm:w-12 sm:h-12" style={{ color: "#2496ED" }} /> },
              { label: "Flutter", icon: <SiFlutter className="w-10 h-10 sm:w-12 sm:h-12" style={{ color: "#02569B" }} /> },
              { label: "Android", icon: <FaAndroid className="w-10 h-10 sm:w-12 sm:h-12" style={{ color: "#3DDC84" }} /> },
            ].map((tech, idx) => (
