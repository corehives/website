...
export default function OutsourcingHero() {
  ...
  return (
    <section className="relative overflow-hidden pt-28 pb-20 sm:pt-36 sm:pb-28">
      {/* Background lights */}
      <div
        className="pointer-events-none absolute -top-32 -left-32 w-[600px] h-[600px] rounded-full z-0"
        style={{
          background:
      ...
      />
      <div
        className="pointer-events-none absolute top-1/3 right-0 w-[400px] h-[500px] z-0"
        style={{
          background:
            "radial-gradient(ellipse at right, rgba(7,190,184,0.05) 0%, transparent 65%)",
        }}
      />
        ...
        <div className="flex flex-col lg:flex-row items-center gap-14 lg:gap-10">
          ...
          <div className="w-full lg:w-[52%]">
            ...
            >
              ...
              overhead, no onboarding delays. CoreHives talent operates as your
              own, with your tools, your workflows, your timezone.
            </p>

            <div ref={ctaRef} className="flex flex-wrap gap-4 mb-8">
              <CTAButton href="/contact">Build Your Extended Team</CTAButton>
            ...
            <div className="relative w-full max-w-[460px]">
              ...
              >
                    ...
                    >
                      <div className="relative flex-shrink-0">
                        <div
                          ...
                          style={{
                            background: `${eng.color}22`,
                            border: `1.5px solid ${eng.color}55`,
                          }}
                        >
                          {eng.initials}
                        </div>
                        <span
                          className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full border-2 border-[#000405]"
                          style={{
                            background:
                              eng.status === "online" ? "#34D399" : "#F4A623",
                          }}
                        />
                      </div>
                ...
                <div className="px-4 pb-4">
                  ...
                  >
                    <span
                      className="block text-[10px] uppercase tracking-widest mb-2.5"
                      style={{ color: "rgba(255,255,255,0.3)" }}
                    >
                      Core Stack
                    </span>
              ...
              <div
                ...
                style={{
                  ...
                  backdropFilter: "blur(12px)",
                  boxShadow: "0 4px 24px rgba(7,190,184,0.10)",
                }}
              >
                <span
                  className="block text-lg font-extrabold"
